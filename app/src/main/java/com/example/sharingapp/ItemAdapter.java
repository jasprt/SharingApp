...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /* TODO implement Borrower name in Borrowed View
          String borrower = "Borrower: " + item.getBorrower().getUsername();
          TextView borrower_tv = (TextView) convertView.findViewById(R.id.borrower_tv); */
